...
const APP_CONTEXT = `
<app-context>
The name of the application is "NIBR Biomni Canvas". NIBR Biomni Canvas is a web application where users have a chat window and a canvas to display an artifact.
